 ...
 * 
 */
@WebServiceClient(name = "UserWebService", targetNamespace = "http://webservice.lijiao.com/", wsdlLocation = "http://localhost:8080/J2EEPro/UserWebService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName USERWEBSERVICE_QNAME = new QName("http://webservice.lijiao.com/", "UserWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/J2EEPro/UserWebService?WSDL");
    ...
    public UserWebService getUserWebServicePort() {
        return super.getPort(new QName("http://webservice.lijiao.com/", "UserWebServicePort"), UserWebService.class);
    }
    ...
    public UserWebService getUserWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.lijiao.com/", "UserWebServicePort"), UserWebService.class, features);
    }
